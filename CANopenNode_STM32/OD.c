...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1005_COB_ID_SYNCMessage = 0x00000001,
    ...
    .x1019_synchronousCounterOverflowValue = 0x80,
    ...
    .x1400_RPDOCommunicationParameter = {
        ...
        .COB_IDUsedByRPDO = 0x8000021C,
        .transmissionType = 0xFE,
        .eventTimer = 0x0000
    },
    .x1401_RPDOCommunicationParameter = {
        .highestSub_indexSupported = 0x05,
        .COB_IDUsedByRPDO = 0x8000031C,
        .transmissionType = 0xFE,
        .eventTimer = 0x0000
    },
    .x1402_RPDOCommunicationParameter = {
        .highestSub_indexSupported = 0x05,
        .COB_IDUsedByRPDO = 0x8000041C,
        .transmissionType = 0xFE,
        .eventTimer = 0x0000
    },
    .x1403_RPDOCommunicationParameter = {
        .highestSub_indexSupported = 0x05,
        .COB_IDUsedByRPDO = 0x8000051C,
        .transmissionType = 0xFE,
        .eventTimer = 0x0000
    },
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x6004_temperatures_sub0 = 0x16,
    .x6004_temperatures = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
};
...
typedef struct {
    ...
    OD_obj_record_t o_6000_voltageAndCurrent[3];
    OD_obj_record_t o_6001_STS_AndTTF[3];
    OD_obj_record_t o_6002_TTE_SOC_SOH[4];
    OD_obj_record_t o_6003_RC_AndAE[3];
    OD_obj_array_t o_6004_temperatures;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_voltageAndCurrent = {
        {
            .dataOrig = &OD_RAM.x6000_voltageAndCurrent.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6000_voltageAndCurrent.voltage,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x6000_voltageAndCurrent.current,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_6001_STS_AndTTF = {
        {
            .dataOrig = &OD_RAM.x6001_STS_AndTTF.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6001_STS_AndTTF.STS,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x6001_STS_AndTTF.TTF,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_6002_TTE_SOC_SOH = {
        {
            .dataOrig = &OD_RAM.x6002_TTE_SOC_SOH.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6002_TTE_SOC_SOH.TTE,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x6002_TTE_SOC_SOH.SOC,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x6002_TTE_SOC_SOH.SOH,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_6003_RC_AndAE = {
        {
            .dataOrig = &OD_RAM.x6003_RC_AndAE.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6003_RC_AndAE.RC,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x6003_RC_AndAE.AE,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_6004_temperatures = {
        .dataOrig0 = &OD_RAM.x6004_temperatures_sub0,
        .dataOrig = &OD_RAM.x6004_temperatures[0],
        .attribute0 = ODA_SDO_R,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x03, ODT_REC, &ODObjs.o_6000_voltageAndCurrent, NULL},
    {0x6001, 0x03, ODT_REC, &ODObjs.o_6001_STS_AndTTF, NULL},
    {0x6002, 0x04, ODT_REC, &ODObjs.o_6002_TTE_SOC_SOH, NULL},
    {0x6003, 0x03, ODT_REC, &ODObjs.o_6003_RC_AndAE, NULL},
    {0x6004, 0x17, ODT_ARR, &ODObjs.o_6004_temperatures, NULL},
