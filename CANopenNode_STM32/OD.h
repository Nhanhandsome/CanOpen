...
********************************************************************************
    ...
    File info:
        ...
        Project File: Canconfig.xdd
        File Version: 1

        Created:      3/10/2024 10:14:07 AM
        Created By:   
        Modified:     3/10/2024 9:18:35 PM
        Modified By:  
...
typedef struct {
    ...
    uint8_t x6004_temperatures_sub0;
    uint8_t x6004_temperatures[OD_CNT_ARR_6004];
} OD_RAM_t;
...
#define OD_ENTRY_H6000_voltageAndCurrent &OD->list[27]
#define OD_ENTRY_H6001_STS_AndTTF &OD->list[28]
#define OD_ENTRY_H6002_TTE_SOC_SOH &OD->list[29]
#define OD_ENTRY_H6003_RC_AndAE &OD->list[30]
#define OD_ENTRY_H6004_temperatures &OD->list[31]
